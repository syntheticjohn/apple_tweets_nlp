...
NLP on customer tweets sent to Apple Support to uncover topics over time using NMF (unsupervised topic modeling), and classify tweets as specific product types based on users' initiating tweets using CorEx with anchors (semi-supervised topic modeling)
